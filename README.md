...
8) Перед началом выполнения задания следует удостовериться, что ваш fork не отстает от основного репозитория
   ...
   После обновления своего репозитория необходимо выполнить `git pull`, чтобы обновить и локальную версию 
10) По завершению последнего задания стажировка считается завершенной. Дальнейшие действия обсуждаются с куратором индивидуально
