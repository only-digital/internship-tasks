    ...
    return(
        <header className={styled.header}>
            <div className={styled.header__logo}>
                <svg xmlns="http://www.w3.org/2000/svg" width="72" height="27" viewBox="0 0 72 27" fill="none" className={styled.header__svg}>
                ...
                <div className={styled.header__logo__title}>Creative Digital Production</div>
            </div>
            <div className={styled.header__area}/>
        </header>
    )
} 