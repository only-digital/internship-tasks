...
const Top = () => {
    return (
        <section className={styled.Top}>
            <div className={styled.Top__logo}>
                <svg className={styled.Top__svg} xmlns="http://www.w3.org/2000/svg" width="72" height="27" viewBox="0 0 72 27" fill="none">
                ...
                <p className={styled.Top__logoText}>
                    Creative <br/>
                    Digital <br/>
                    Production <br/>
                </p>
