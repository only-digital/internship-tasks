        ...
        <div className={styled['todo-list']}>
            <div className={styled['todo-list__sidebar']}>
                <div className={styled['todo-list__sidebar__logo']}>
                    <Image
                     src={'https://res.cloudinary.com/dyvmnrk8q/image/upload/v1698050522/Only._rve90e.svg'}
                     width={72}
                     height={27}
                ...
                <div className={styled['todo-list__sidebar__list']}>
                    <div className={styled['todo-list__sidebar__list__label']}>
                        <Image
                        src={'https://res.cloudinary.com/dyvmnrk8q/image/upload/v1698050671/Frame_2131327682_w4ec5s.svg'}
                        width={20}
                        height={20}
                        alt={"Task list label"}
            ...
            <div className={styled['todo-list__tasks']}>
                <div className={styled['todo-list__tasks__placeholder']}>

                </div>
                <div className={styled['todo-list__tasks__wrapper']}>
                    <div className={styled['todo-list__tasks__caption']}>
                    <h2 className={styled['todo-list__tasks__title']}>
                        Список задач
                    </h2>
                    <input 
                    ...
                    <ul className={styled['todo-list__tasks__list']}>
                        {
                            filteredTasks.map((task, index) => ( 
                                ...
                                isCompleted = {false}
                                >
                                   <h3 className={styled['todo-list__task__title']} ref={(el) => taskTitleRefs.current[index] = el} >
                                    {task.title}
                                            <button>
                                        <Image
                                            src={'https://res.cloudinary.com/dyvmnrk8q/image/upload/v1698050798/closeIcon_jtanba.svg'}
                                            width={14}
                                            height={14}
                                            alt={"Task close icon"}
                                    ...
                                    <p className={styled['todo-list__task__desc']}>
                                        {task.text}
                                    </p>
                                </li>
                            ))
