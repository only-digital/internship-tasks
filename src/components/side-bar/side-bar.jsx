import styled from './side-bar.module.scss'

export const SideBar = ({isShowTodoList, setIsShowTodoList}) => {

    return(
        <div className={styled.sideBar}>
            <div
                onClick={()=>setIsShowTodoList(!isShowTodoList)}                
                className={styled.sideBar__btn}
            >
                ...
                <div className={styled.sideBar__btn__name}>Список задач</div>
            </div>
        </div>
    )
}